    ...
    return (
        <div className="mt-4 bg-gray-100 -mx-8 px-8 pt-8">
            ...
            <div className="mt-8 mb-8 grid gap-6 grid-cols-1 md:grid-cols-[2fr_1fr]">
                <div>
                    ...
                    <div className="text-xl mt-2">
                        <div className="mb-2">
                            <h2 className="text-xl">Check-in: {convertTo12HourFormat(place.checkIn)}</h2>
                            <h2 className="text-xl">Check-out: {convertTo12HourFormat(place.checkOut)}</h2>
                        </div>
                        Max number of guests: <span className="font-semibold">{place.maxGuests}</span>
                    </div>
                    <div className="my-4">
                        ...
                        {place.perks && place.perks.length > 0 ? (
                            ...
                            <p className="text-gray-500">No perks available for this place.</p>
                        )}
                    </div>
            ...
            <div className="bg-white -mx-8 px-8 py-8 border-t">
                ...
                <div className="mb-4 mt-2 text-xl text-gray-700 leading-7">
                    {place.extraInfo}
                </div>
            </div>
        </div>
